                ...
                >
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      className="mb-6 p-6 rounded-2xl bg-gradient-to-r from-primary/10 via-primary-light/10 to-secondary/10 border border-primary/20 backdrop-blur-sm"
                    >
                    ...
                    <motion.div
                      ...
                      className="mb-8 p-6 rounded-2xl bg-gradient-to-r from-primary/10 via-primary-light/10 to-secondary/10 border border-primary/20 backdrop-blur-sm"
                    >
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-xl bg-black/30 flex items-center justify-center border border-primary/30">
                          <svg
